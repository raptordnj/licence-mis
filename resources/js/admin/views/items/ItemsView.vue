    ...
    <section class="space-y-4">
        ...
        <div class="flex items-center justify-end gap-2">
            ...
            <span class="pagination-glass text-xs text-slate-600 dark:text-slate-300">
                {{ itemsStore.response.current_page }} / {{ itemsStore.response.last_page }}
            </span>
            <UiButton size="compact" variant="secondary" :disabled="itemsStore.response.current_page >= itemsStore.response.last_page" @click="query.page += 1">
                Next
            </UiButton>
        </div>
